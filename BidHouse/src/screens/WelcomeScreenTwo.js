    ...
    <SafeAreaView style={styles.container}>
      ...
      <Ionicons name="chevron-back" size={30} color="black" style={styles.back}/>
       ...
       <View style={{...styles.heading}}>
        <Text style={styles.headingText}>Instant Property</Text>
      </View>
        <Text style={styles.paragraphText}>
          Be the successful winner and you{'\n'}get your property disbursed{'\n'}
          immediately.
        </Text>
      ...
      <View style={styles.circleView}>
        ...
        <View style={[styles.circle, {marginLeft: 5, marginRight: 5,backgroundColor: '#F76300',width:24}]} />
        <View style={styles.circle} />
      </View>

        <TouchableOpacity onPress={() => navigation.navigate('WelcomeScreenThree')}>
